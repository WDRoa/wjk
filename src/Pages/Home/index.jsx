...
function Home() {
    ...
    if (context.items === null) {      
      ...
      return (
        <div className="text-center w-full col-span-4">
          <p className="text-md font-normal mt-10 dark:text-gray-300">We don't have that product. :-(</p>
        </div>
      );
    }
  };
  ...
  return (
    <Layout>
      ...
      <p className='font-normal text-sm dark:text-gray-300 mb-2'>The best place to get your favorite products</p>
      <input
        type="text"
        id="search-product"
        name="search"
