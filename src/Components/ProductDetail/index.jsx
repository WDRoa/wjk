...
//   return (
//     <aside
//       className={`${context.isProductDetailOpen ? 'product-detail-open' : 'product-detail-closed'} product-detail flex-col fixed right-1 border border-black rounded-lg bg-white dark:bg-gray-800 dark:border-white dark:text-gray-300`}>
//       <div className='flex justify-between items-center p-6'>
//         <h2 className='font-medium text-xl select-none dark:bg-gray-800 dark:text-gray-300'>Detail</h2>
//         <XMarkIcon
//           className='h-7 w-7 bg-gray-700 rounded-2xl text-white cursor-pointer hover:text-blue-600 dark:bg-gray-300 dark:text-black'
...
//         <div className=''>
//           <button
//             className={`bg-black py-1 mt-5 text-white w-full rounded-lg select-none hover:bg-blue-700 font-bold text-lg dark:bg-gray-300 dark:text-black`}
