...
const ProductDetail = () => {
  ...
  return (
    <aside
      ...
      } product-detail flex-col fixed right-1 border border-black rounded-lg bg-white z-20 dark:bg-black dark:border-white dark:text-gray-300`}
    >
      <div className="flex justify-between items-center p-6">
        <h2 className="font-medium text-xl select-none dark:text-gray-300">
          Detail
        </h2>
        <XMarkIcon
          tabIndex={0}
      ...
      <div className="flex flex-col overflow-y-auto p-4">
        ...
        <div className="flex flex-col">
          <span className="font-medium text-2xl mb-2 select-none">
        ...
        <div className="mt-5 flex justify-center">
          {isInCart ? (
            ...
            >
              <CheckIcon className="h-6 w-6 inline-block mr-2" /> Already in
              Cart
            </button>
          ) : (
            <button
