...
const Card = (data) => {
  ...
  return (
    <div
      className='bg-white cursor-pointer w-56 h-60 rounded-lg p-2 hover:border hover:border-black'
      ...
      <figure className='relative mb-2 w-full h-4/5 select-none'>
        ...
        <img className='max-w-full max-h-full object-cover rounded-lg' src={data.data.image} alt={data.data.title} />
